...
class QWebAnalyzer:
    ...
    def analyze(self):
        ...
        output.append("")
        output.append("=" * 80)
        output.append(" Generated by QWeb Report Analyzer - Jose Bertorelli ".center(80, "="))
        output.append(" https://github.com/JoseAleBerto/qweb-report-analyzer ".center(80, "="))
        output.append("=" * 80)
...
class ReportAnalyzer(models.AbstractModel):
    ...
    def _collect_all_views_data(self, report):
        ...
        return {
            ...
            'entry_point': report.report_name,
        }
    ...
    def analyze_report(self, report_id):
        ...
        _logger.info("QWeb Report Analyzer: running analysis...")
